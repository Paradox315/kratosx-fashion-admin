export default {
  ...
  'workplace.refresh': '刷新数据',
  'workplace.contentData': '内容数据',
  'workplace.popularContent': '线上热门内容',
  'workplace.popularContent.popular': '热门推荐',
  'workplace.popularContent.latest': '最新推荐',
  'workplace.categoriesPercent': '推荐数据占比',
  'workplace.item.image': '图片',
  'workplace.item.labels': '标签',
  'workplace.figures.choose': '选择形象',
  'workplace.item.tryon': '试穿',
  'workplace.tryon.success': '试穿成功',
  'workplace.pecs': '个',
};
