export default {
  ...
  'workplace.popularContent.popular': 'popular',
  'workplace.popularContent.latest': 'latest',
  'workplace.categoriesPercent': 'Categories Percent',
  'workplace.item.image': 'image',
  'workplace.item.labels': 'labels',
  'workplace.figures.choose': 'Choose Figure',
  'workplace.item.tryon': 'Try On',
  'workplace.tryon.success': 'Try On Clothes Success',
  'workplace.pecs': 'pecs',
};
