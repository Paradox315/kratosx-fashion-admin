export default {
  ...
  'userSetting.label.email': '电子邮箱',
  'userSetting.label.gender': '性别',
  'userSetting.label.age': '年龄',
  'userSetting.label.address': '地址',
  'userSetting.label.country': '国家',
  'userSetting.label.city': '城市',
  ...
  'userSetting.basicInfo.form.label.unknown': '未知',
  'userSetting.basicInfo.form.label.female': '女性',
  'userSetting.basicInfo.form.label.male': '男性',
  ...
  'userSetting.SecuritySettings.modal.password': '修改密码',
  'userSetting.SecuritySettings.form.oldPassword': '旧密码',
  'userSetting.SecuritySettings.form.oldPassword.placeholder': '请输入旧密码',
  'userSetting.SecuritySettings.form.newPassword': '新密码',
  'userSetting.SecuritySettings.form.newPassword.placeholder': '请输入新密码',
  'userSetting.SecuritySettings.form.confirmPassword': '确认密码',
  'userSetting.SecuritySettings.form.confirmPassword.placeholder': '请确认密码',
