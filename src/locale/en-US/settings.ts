export default {
  ...
  'settings.navbar.fullScreen': 'Click to enter full screen',
  ...
  'settings.saveSetting': 'Save Settings',
  'settings.saveSetting.message':
    'The configuration is saved successfully, please restart the project.',
